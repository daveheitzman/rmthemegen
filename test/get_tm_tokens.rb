...
#    puts i.to_s+" |e| |e| "+@tm_xml_in["dict"][0]["array"][0]["dict"][i]["string"][1].inspect if @tm_xml_in["dict"][0]["array"][0]["dict"][i]["string"]
    @element_tokens[@tm_xml_in["dict"][0]["array"][0]["dict"][i]["string"][1].to_s]=1 if @tm_xml_in["dict"][0]["array"][0]["dict"][i]["string"]
...
#  @outf.close
  ...
  puts "@element_tokens: "+@element_tokens.inspect
  puts "@element_scopes: "+@element_scopes.inspect
