...
module RMThemeGen
  class RMThemeParent
    ...
    #the following is a map where :k = the symbol name in rubymine, and :v is the symbol name in textmate.
    ...
    :RUBY_EXPR_IN_STRING =>["name","scope",{}],
    :RUBY_GVAR =>["name","scope",{}],
    :RUBY_HASH_ASSOC =>["name","scope",{}],
    :RUBY_HEREDOC_CONTENT =>["name","scope",{}],
    :RUBY_HEREDOC_ID =>["name","scope",{}],
    :RUBY_IDENTIFIER =>["name","scope",{}],
    :RUBY_IMPORT_CALL =>["name","scope",{}],
    :RUBY_INVALID_ESCAPE_SEQUENCE=>["name","scope",{}], 
    :RUBY_IVAR =>["name","scope",{}],
    :RUBY_KEYWORD =>["name","scope",{}],
    :RUBY_LINE_CONTINUATION=>["name","scope",{}], 
    :RUBY_LOCAL_VAR_ID =>["name","scope",{}],
    :RUBY_METHOD_NAME =>["name","scope",{}],
    :RUBY_NTH_REF =>["name","scope",{}],
    :RUBY_NUMBER =>["name","scope",{}],
    ...
    :RUBY_REGEXP =>["name","scope",{}],
    :RUBY_REQUIRE_ARG_CALL=>["name","scope",{}], 
    :RUBY_REQUIRE_CALL =>["name","scope",{}],
    :RUBY_SEMICOLON =>["name","scope",{}],
    :RUBY_SPECIFIC_CALL =>["name","scope",{}],
